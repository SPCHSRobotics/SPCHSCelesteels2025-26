...
(Motif GPP: 21
Motif PGP: 22
Motif PPG: 23) obelisk apriltags
Red Goal: 24
...
//example motif usage
@Autonomous(name = "Auto Top Blue", group = "Linear OpMode")
@Configurable // Panels
@SuppressWarnings("FieldCanBeLocal") // Stop Android Studio from bugging about variables being predefined
public class alinaMotifExample extends LinearOpMode {
    ...
    private PathChain grabPPG; //grab purple purple green balls
